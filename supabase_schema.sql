...
CREATE TABLE IF NOT EXISTS store_settings (
    ...
    hero_badge TEXT DEFAULT 'Distribuidora & Varejo Especializado',
    hero_title TEXT DEFAULT 'A Força da Hidráulica e a Potência da Elétrica',
    hero_subtitle TEXT DEFAULT 'Cabos elétricos, disjuntores, quadros, tubos, conexões e iluminação industrial de alta performance. Pronta entrega para construtoras, instaladores e indústrias.',
    hero_cta_primary TEXT DEFAULT 'Explorar Produtos',
    hero_cta_whatsapp TEXT DEFAULT 'Orçamento via WhatsApp',
    feature_1_title TEXT DEFAULT 'Normatização Rigorosa ABNT',
    feature_1_desc TEXT DEFAULT 'Materiais 100% certificados pelo Inmetro e normas vigentes com garantia de procedência.',
    feature_2_title TEXT DEFAULT 'Entrega Rápida em até 24h',
    feature_2_desc TEXT DEFAULT 'Logística ágil e frota preparada para atender sua obra sem atrasos.',
    feature_3_title TEXT DEFAULT 'Condições Especiais para PJ',
    feature_3_desc TEXT DEFAULT 'Faturamento facilitado, atendimento técnico consultivo e descontos no atacado.',
    metric_1_val TEXT DEFAULT '+10.000',
    metric_1_lbl TEXT DEFAULT 'Itens em Estoque',
    metric_2_val TEXT DEFAULT '+5.000',
    metric_2_lbl TEXT DEFAULT 'Obras Abastecidas',
    metric_3_val TEXT DEFAULT '24h',
    metric_3_lbl TEXT DEFAULT 'Entrega Regional',
    quote_banner_title TEXT DEFAULT 'Tem uma lista de materiais ou projeto em mãos?',
    quote_banner_desc TEXT DEFAULT 'Envie sua planilha ou foto da lista direto pelo WhatsApp da loja. Montamos seu orçamento em minutos com as melhores condições.',
