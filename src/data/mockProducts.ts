...
export const INITIAL_STORE_SETTINGS: StoreSettings = {
  ...
  hero_badge: 'Loja Especializada em Elétrica & Hidráulica',
  hero_title: 'Tudo para sua Obra e Reforma com Pronta Entrega e Preço Justo',
  hero_subtitle: 'Linha completa de materiais elétricos, hidráulicos, iluminação e ferramentas. Atendimento consultivo, procedência comprovada e mais de 6 anos de confiança.',
  hero_cta_primary: 'Ver Catálogo Completo',
  hero_cta_whatsapp: 'Orçamento Rápido no WhatsApp',
  feature_1_title: '+6 Anos de Tradição',
  feature_1_desc: 'Mais de 6 anos de atuação com milhares de clientes e parceiros satisfeitos.',
  feature_2_title: 'Pronta Entrega Garantida',
  feature_2_desc: 'Estoque real a pronta entrega para que sua obra ou reforma nunca fique parada.',
  feature_3_title: 'Atendimento Especializado',
  feature_3_desc: 'Orientação técnica consultiva, agilidade e suporte completo para o seu pedido.',
  metric_1_val: '+6 Anos',
  metric_1_lbl: 'De Mercado & Tradição',
  metric_2_val: '+15.000',
  metric_2_lbl: 'Clientes Atendidos',
  metric_3_val: '+50.000',
  metric_3_lbl: 'Produtos Vendidos',
  metric_4_val: '99.8%',
  metric_4_lbl: 'Avaliação Positiva',
